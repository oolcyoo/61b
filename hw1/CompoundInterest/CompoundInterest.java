...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return presentValue * Math.pow(1+(rate-inflationRate)*0.01, (numYears(targetYear)));
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        if (targetYear == 2022) {
            ...
            return perYear * Math.pow((1 + rate * 0.01), (numYears(targetYear))) + totalSavings(perYear, targetYear - 1, rate);
        }
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        if (targetYear == 2022) {
            ...
            return perYear * Math.pow(1+(rate-inflationRate)*0.01, (numYears(targetYear))) + totalSavingsReal(perYear, targetYear - 1, rate, inflationRate);
        }
    }
