...
public class ArrayHeap<T> {
    ...
    private void bubbleUp(int index) {
        while ((index != 1 && index != 0) && (minPriorityIndex(index, getParentOf(index)) != getParentOf(index))) {
    ...
    private void bubbleDown(int index) {
        while ((index < size()) && (minPriorityIndex(index, getRightOf(index)) == getRightOf(index) || minPriorityIndex(index, getLeftOf(index)) == getLeftOf(index))) {
            swap(index, minPriorityIndex(getLeftOf(index), getRightOf(index)));
            index = minPriorityIndex(getLeftOf(index), getRightOf(index));
        }
    }
