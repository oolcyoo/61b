...
public class Main {
    ...
    public static void setupPersistence() {
        ...
        File dogPlanet = new File(CWD + "capers/dogs");
        dogPlanet.mkdir();
        File story = new File(CWD + "capers/story.txt");
        try {
            story.createNewFile();
    ...
    public static void writeStory(String[] args) {
        ...
        File wayToHome = Utils.join(CWD + "capers/",
                args[0] + ".txt");
        String pre = Utils.readContentsAsString(wayToHome);

        Utils.writeContents(wayToHome, pre + args[1] + "\n");
        System.out.println(pre + args[1]);
    ...
    public static void makeDog(String[] args) {
        ...
        Dog goldenRetriever = new Dog(args[1], args[2],
                Integer.parseInt(args[3]));

        goldenRetriever.saveDog();
