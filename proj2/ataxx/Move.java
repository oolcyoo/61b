...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = false;
        boolean moved1 = (abs(_col0 - _col1) == 0 && abs(_row0 - _row1) == 1);
        boolean moved2 = (abs(_col0 - _col1) == 1 && abs(_row0 - _row1) == 0);
        boolean moveDiag = (abs(_col0 - _col1) == 1 && abs(_row0 - _row1) == 1);
        _isExtend = moved1 || moved2 || moveDiag;

        _isJump = false;
        boolean jumped1 = (abs(_col0 - _col1) == 0 && abs(_row0 - _row1) == 2);
        boolean jumped2 = (abs(_col0 - _col1) == 2 && abs(_row0 - _row1) == 0);
        boolean jumped3 = (abs(_col0 - _col1) == 2 && abs(_row0 - _row1) == 2);
        boolean jumped4 = (abs(_col0 - _col1) == 2 && abs(_row0 - _row1) == 1);
        boolean jumped5 = (abs(_col0 - _col1) == 1 && abs(_row0 - _row1) == 2);
        _isJump = jumped1 || jumped2 || jumped3 || jumped4 || jumped5;
    }
