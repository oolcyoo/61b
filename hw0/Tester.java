...
public class Tester {
    ...
    public static void isEvenTest() {
        ...
        assertFalse(Solutions.isEven(33), "IsEvenTest");
        assertTrue(Solutions.isEven(222222222), "IsEvenTest");
    }
    ...
    // UNCOMMENT EVERYTHING BELOW TO RUN MORE TESTS.
     ...
     public static void maxTest() {
        ...
        assertIntEquals(99999, Solutions.max(new int[] {888,999,666,324,3535,99999,423,2222,4342,99999,9800}), "maxTest");
    }
